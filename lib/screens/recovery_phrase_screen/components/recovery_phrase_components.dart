    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 30,),
          Center(child: Image(image: AssetImage(Assets.recovery), width: 150, height: 150,),),
          SizedBox(height: 20,),
          Text('Make sure you have carefully written down your recovery phrase somewhere safe. You will need this phrase to use and restore your wallet.',
            style: TextStyle(height: 1.3, letterSpacing: 0.1),
          ),
          SizedBox(height: 5,),
          Text('Phrase is case sensitive',style: TextStyle(letterSpacing: 0.1, fontWeight: boldStyle),),
          SizedBox(height: 30,),
          Padding(
